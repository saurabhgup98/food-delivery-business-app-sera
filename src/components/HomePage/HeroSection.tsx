...
import { getHeroPrimaryButtonProps, getHeroSecondaryButtonProps } from '../utils/buttonUtils';
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center animate-fade-in-up delay-800">
          ...
          <div className="w-full sm:w-48 h-10">
            <PrimaryIconTextBtn {...getHeroPrimaryButtonProps(onRegisterClick || (() => {}))} />
          </div>
          
          {/* Secondary Button - Yellow Outline */}
          <div className="w-full sm:w-48 h-10">
            <PrimaryIconTextBtn {...getHeroSecondaryButtonProps(handleScrollToSection)} />
          </div>
        </div>

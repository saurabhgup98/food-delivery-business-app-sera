...
const DASHBOARD_API_BASE_URL = 'http://localhost:5001'; // Local backend URL for testing
// For production, use: 'https://food-delivery-business-app-sera-backend-d1wiulenw.vercel.app'
